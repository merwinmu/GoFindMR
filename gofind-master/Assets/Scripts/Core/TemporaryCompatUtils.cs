...
{
    public class TemporaryCompatUtils
    {
        /// <summary>
        ...
        {
            return CineastWrapper.CineastConfig.mediaHost + "/images/"+ mmo.GetPath();
        }

        public static string GetThumbnailUrl(ObjectData mmo)
        {
            return CineastWrapper.CineastConfig.mediaHost + "thumbnails/" + mmo.Id + "/" + mmo.Id + "_1.png";
        }
    }
}